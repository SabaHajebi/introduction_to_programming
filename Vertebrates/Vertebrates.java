...
public class Vertebrates {
	...
	public static void main(String[] args) {
		...
		System.out.print("Is your animal cold blooded (Yes/No)?");
		String coldBloodedAnswer = input.next();
		boolean coldBlooded = 
				coldBloodedAnswer.equalsIgnoreCase("Yes");
		if (!coldBlooded)
		{
			...
			boolean hasWings = 
					hasWingsAnswer.equalsIgnoreCase("Yes");
			if(hasWings)
